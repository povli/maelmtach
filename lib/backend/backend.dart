...
import 'schema/chatchatchat_record.dart';
...
export 'schema/chatchatchat_record.dart';
...
/// Functions to query ChatchatchatRecords (as a Stream and as a Future).
Future<int> queryChatchatchatRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ChatchatchatRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ChatchatchatRecord>> queryChatchatchatRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ChatchatchatRecord.collection,
      ChatchatchatRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ChatchatchatRecord>> queryChatchatchatRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
