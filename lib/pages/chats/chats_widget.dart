  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ChatchatchatRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChatchatchatRecord> chatsChatchatchatRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final chatsChatchatchatRecord = chatsChatchatchatRecordList.isNotEmpty
            ? chatsChatchatchatRecordList.first
            : null;
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  if (_model.textController.text != '') {
                                    ...
                                    await chatsChatchatchatRecord!.reference
